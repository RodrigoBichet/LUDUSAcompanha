...
| Eventos do jogo | Fase iniciada, tentativa, acerto, erro e fim de sessao | Permite reconstruir a sequencia de interacoes de uma sessao | Eventos descrevem o uso do jogo, nao causas pedagogicas definitivas | Linha do tempo da sessao |
